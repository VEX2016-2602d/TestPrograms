...
#pragma config(Motor,  port6,           _chassisR_M,   tmotorVex393HighSpeed_MC29, openLoop, driveRight)
#pragma config(Motor,  port7,           _chassisL_M,   tmotorVex393HighSpeed_MC29, openLoop, reversed, driveLeft)
